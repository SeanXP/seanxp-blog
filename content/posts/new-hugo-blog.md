...
* 网站统计：`GoatCounter`
	* <https://github.com/arp242/goatcounter> ，直接部署在 vps，修改 hugo 模板代码，新增一段上报脚本。
	* [Hugo添加自定义css和javascript | Finisky Garden](https://finisky.github.io/hugoaddcssjs/)
* 全文搜索：`Algolia`
	* 使用 `Algolia` 作为全文搜索服务，支持中文搜索，搜索结果高亮显示，搜索体验非常好。
	* [Hugo 添加 algolia 搜索功能 - Stilig's blog](https://stilig.me/posts/hugo-adds-algolia/)
* 评论系统: `Remark42`
	* Go 语言实现，支持多种方式登录（包括匿名登录）、可以直接在评论界面管理评论。参考官方教程，docker 部署到 vps。
	* [更换博客评论系统 | Reorx’s Forge](https://reorx.com/blog/blog-commenting-systems/)
	* [史上最全Remark42评论系统安装教程 | 奥国天空](https://matteo.eu.org/2023/20230207024855.html#11-%E5%8A%9F%E8%83%BD)
	* [从零开始搭建你的免费博客评论系统（Remark42 + fly.io） · Pseudoyu](https://www.pseudoyu.com/zh/2024/07/22/free_commenting_system_using_remark42_and_flyio/)
		* [fly.io](http://fly.io) 最近几个月经常超过免费额度($5），且没有提示，第二个月直接扣费了。体验较差，放弃使用。改成 vps 直接部署。